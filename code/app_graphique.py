################################################################
### Fichier qui lance l'application graphique de simulations ###
################################################################
...
def choix_nb_noeuds(event=None):
    ...
    frame_choixm_g.pack(expand=True)
    bouton10.focus_set()
...
frame_choixm_g = Frame(fenetre)
label4 = Label(frame_choixm_g, text="Choix de la méthode de construction du graphe")
value3 = StringVar()
value3.set("")
bouton7 = Radiobutton(frame_choixm_g, text="Génération aléatoire", variable=value3, value=1)
bouton8 = Radiobutton(frame_choixm_g, text="Méthode d'Erdos-Renyi", variable=value3, value=2)
bouton9 = Radiobutton(frame_choixm_g, text="Graphe Small-World", variable=value3, value=3)
bouton7.bind("<Return>", activation_radio)
bouton8.bind("<Return>", activation_radio)
bouton9.bind("<Return>", activation_radio)
bouton10=Button(frame_choixm_g, text="Valider", command=choix_methode)
...
bouton11=Button(frame_er, text="Valider", command=debut_sr)
...
bouton12=Button(frame_sw, text="Valider", command=debut_sr)
...
## proba S -> R
frame_sr = Frame(fenetre)
labelsr = Label(frame_sr, text="Entrer la probabilité qu'un noeud passe de l'état S à R")
valuesr = StringVar()
valuesr.set("")
entreesr = Entry(frame_sr, textvariable=valuesr, width=30)
boutonsr = Button(frame_sr, text="Valider", command=proba_sr)
...
frame_nbr = Frame(fenetre)
labelnbr = Label(frame_nbr, text="Entrer le nombre de noeuds résistants au début de la simulation")
snbr = Spinbox(frame_nbr, from_=0, to=500)
boutonnbr = Button(frame_nbr, text="Valider", command=citer_resistants)
...
## nb honeypots
frame_hp = Frame(fenetre)
labelhp = Label(frame_hp, text="Entrer le nombre de honeypots")
shp = Spinbox(frame_hp, from_=0, to=500)
boutonhp = Button(frame_hp, text="Valider", command=nb_hps)
...
frame_shp = Frame(fenetre)
labelhps = Label(frame_shp, text="Combien de ces honeypots adopteront la stratégie intelligente ? \n Les autres honeypots adopteront la stratégie naïve")
shps = Spinbox(frame_shp, from_=0, to=500)
boutonhps = Button(frame_shp, text="Valider", command=choix_type_strat)
...
frame_ts = Frame(fenetre)
labelts = Label(frame_ts, text="Choisir le type de stratégie souhaité")
valuets = StringVar()
valuets.set("")
boutonts1 = Radiobutton(frame_ts, text="Utiliser une stratégie de propagation basique", variable = valuets, value=1)
boutonts2 = Radiobutton(frame_ts, text= "Utiliser une stratégie de propagation qui priorise les noeuds de haut degré", variable=valuets, value=2)
boutonts1.bind("<Return>", activation_radio)
boutonts2.bind("<Return>", activation_radio)
boutontsv = Button(frame_ts, text = "Valider", command=choix_strat) 
